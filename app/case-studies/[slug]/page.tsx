...
const CASE_STUDIES = [
  {
    ...
    challenge: {
      heading: 'The problem with regulatory documentation at scale.',
      body: 'Regulatory submissions for biologics require extensive CTD documentation — highly labour-intensive and accuracy-critical, with little room for error. Manual processes created bottlenecks, inconsistency across modules, and knowledge locked in individual contributors rather than the practice.',
    },
    approach: {
      heading: 'AI-enabled documentation — with humans in the loop.',
    ...
    impact: {
      heading: 'Accelerated capacity, consistent quality.',
      body: 'Accelerated drafting across CTD modules, improved consistency across the practice, enhanced knowledge reuse across submissions, and a scalable delivery capability. The firm can now handle a larger submission volume with the same senior team — the AI handles the first draft, the experts handle judgement.',
    },
  },
  {
    ...
    challenge: {
      heading: 'Quality systems built for early-stage don\'t survive commercialisation.',
      body: 'Preparing for late-stage clinical development and commercialisation with document-driven, fragmented quality processes. Leadership needed a modern digital PQS, inspection-ready at commercial scale — but without a clear picture of what that looked like or how to get there.',
    },
    approach: {
      heading: 'A blueprint before a build.',
      body: 'A PQS transformation assessment across process architecture, GxP alignment, system landscape and scalability — culminating in a Digital PQS Blueprint with digital quality architecture, integrated workflows, governance and validation strategy, and a phased roadmap. The sequence was designed to avoid over-investing in systems before the architecture decision was made.',
    },
    impact: {
      heading: 'Clarity, alignment, and a path to inspection readiness.',
      body: 'A clear roadmap aligned to regulatory expectations, improved inspection readiness across quality functions, and leadership alignment on the target digital quality architecture. The blueprint gave the executive team a shared language for what had previously been a fragmented internal debate.',
    },
  },
  {
    ...
    challenge: {
      ...
      body: 'Large data volumes across lab, manufacturing and quality systems with no integrated architecture — limiting the ability to identify process trends, support batch disposition, or build an AI-ready foundation. Decisions were made on individual data pulls rather than integrated operational visibility.',
    },
    approach: {
      heading: 'Architecture before automation.',
    ...
    impact: {
      heading: 'An operational data layer that supports AI.',
      body: 'Integrated data visibility across manufacturing, quality and lab functions, a foundation for AI-enabled analytics, enhanced trend identification across batches, and scalable, regulatory-aligned infrastructure. The data architecture now supports future AI initiatives without requiring architectural rework.',
    },
  },
] as const;
    ...
    <main>
      ...
      >
        ...
        <div className="relative max-w-[1240px] mx-auto px-6 md:px-10 pt-20 pb-16">
          ...
          <p className="font-mono text-[0.6875rem] tracking-[0.14em] uppercase text-[var(--text-tertiary)] mb-3">
            {client}
          </p>
          <h1 className="font-sans font-semibold text-[clamp(2rem,3.5vw,3.5rem)] leading-[1.08] tracking-[-0.02em] mt-0 mb-4 max-w-[26ch]">
            {title}
          </h1>
      ...
      <section aria-label="Challenge" className="bg-[var(--surface-sunken)] border-b border-[var(--border-subtle)]">
        <div className="max-w-[1240px] mx-auto px-6 md:px-10 py-16 grid grid-cols-1 gap-8 md:grid-cols-[200px_1fr]">
          <div>
            <Eyebrow rule>Challenge</Eyebrow>
          </div>
          <div>
            <h2 className="font-sans font-semibold text-[1.75rem] leading-[1.2] tracking-[-0.02em] mb-5 max-w-[30ch]">
              {challenge.heading}
            </h2>
            <p className="font-serif text-[1.125rem] leading-[1.65] text-[var(--text-secondary)]">
              {challenge.body}
      ...
      <section aria-label="Impact" className="bg-[var(--surface-sunken)] border-b border-[var(--border-subtle)]">
        <div className="max-w-[1240px] mx-auto px-6 md:px-10 py-16 grid grid-cols-1 gap-8 md:grid-cols-[200px_1fr]">
          ...
          <div>
            ...
            <p className="font-sans font-medium text-[var(--accent)] mt-6">
              {outcome}
            </p>
          </div>
        </div>
      ...
      <section
        ...
        className="bg-[var(--navy-850)] border-t border-[var(--border-default)]"
      >
